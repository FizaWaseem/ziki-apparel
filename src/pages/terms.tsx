...
export default function TermsPage() {
  return (
    <>
      <Head>
        <title>Terms of Service - Ziki Apparel</title>
        <meta name="description" content="Read Ziki Apparel's Terms of Service. Review our terms and conditions for using our website and services." />
        <meta name="keywords" content="terms of service, terms and conditions, legal" />
      </Head>
      <Layout>
            ...
            <div className="bg-white rounded-lg shadow-sm p-8">
              ...
              <div className="prose prose-lg max-w-none text-gray-700">
                ...
                <section className="mb-8">
                  ...
                  <p className="mb-4">
                    By accessing and using Ziki Apparel&apos;s website and services, you accept and agree to be
                ...
                <section className="mb-8">
                  ...
                  <p className="mb-4">
                    Permission is granted to temporarily download one copy of the materials on Ziki Apparel&apos;s
                ...
                <section className="mb-8">
                  ...
                  <p className="mb-4">
                    ...
                    any product at any time. Prices for our products are subject to change without notice.
                  </p>
                  <ul className="list-disc list-inside mb-4 space-y-2">
                ...
                <section className="mb-8">
                  ...
                  <ul className="list-disc list-inside mb-4 space-y-2">
                    ...
                    <li>You are responsible for any taxes, duties, or customs fees</li>
                ...
                <section className="mb-8">
                  ...
                  <p className="mb-4">
                    We will make every effort to ship your order promptly. Delivery times are estimates
                    and not guaranteed.
                  </p>
                  <ul className="list-disc list-inside mb-4 space-y-2">
                    <li>Risk of loss and title for products pass to you upon delivery</li>
                    <li>Shipping costs are calculated at checkout</li>
                    <li>International shipping may be subject to additional fees and delays</li>
                  </ul>
                </section>
                ...
                <section className="mb-8">
                  ...
                  <p className="mb-4">
                    ...
                    you may return items within 30 days of purchase.
                  </p>
                  <ul className="list-disc list-inside mb-4 space-y-2">
                    ...
                    <li>Sale items may not be eligible for returns</li>
                  </ul>
                </section>
                ...
                <section className="mb-8">
                  ...
                  <p className="mb-4">
                    The materials on Ziki Apparel&apos;s website are provided on an &apos;as is&apos; basis. Ziki Apparel
                ...
                <section className="mb-8">
                  ...
                  <p className="mb-4">
                    In no event shall Ziki Apparel or its suppliers be liable for any damages (including,
                    without limitation, damages for loss of data or profit, or due to business interruption)
                    arising out of the use or inability to use the materials on Ziki Apparel&apos;s website.
                  </p>
                </section>
                ...
                <section className="mb-8">
                  ...
                  <p className="mb-4">
                    ...
                    of the jurisdiction in which Ziki Apparel operates.
                  </p>
                </section>
                ...
                <section className="mb-8">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <p className="mb-2"><strong>Email:</strong> legal@zikiapparel.com</p>
