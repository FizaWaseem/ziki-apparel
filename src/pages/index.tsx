        ...
        <section className="py-16 bg-gradient-to-r from-blue-50 to-indigo-50">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-8">Why Choose Ziki Apparel?</h2>
              ...
              <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-white p-6 rounded-lg shadow-sm">
                  ...
                  <p className="text-gray-600 text-sm">What you see is what you pay. Transparent pricing always.</p>
                </div>

                <div className="bg-white p-6 rounded-lg shadow-sm">
                  <div className="text-3xl mb-3">★</div>
                  <h3 className="font-semibold text-gray-900 mb-2">Premium Quality</h3>
                  <p className="text-gray-600 text-sm">High-quality denim crafted with attention to detail.</p>
                </div>

                <div className="bg-white p-6 rounded-lg shadow-sm">
                  <div className="text-3xl mb-3">💰</div>
                  <h3 className="font-semibold text-gray-900 mb-2">Best Prices</h3>
                  <p className="text-gray-600 text-sm">Affordable pricing without compromising on quality.</p>
                </div>
              </div>
            </div>
          </div>
