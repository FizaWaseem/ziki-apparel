...
export default function SignIn() {
  ...
  return (
    <>
      <Head>
        <title>Sign In to Your Ziki Apparel Account</title>
        <meta name="description" content="Sign in to your Ziki Apparel account. Access your orders, profile, saved items, and preferences." />
