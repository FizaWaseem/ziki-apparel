...
export default function ContactPage() {
  ...
  return (
    <>
      <Head>
        <title>Contact Ziki Apparel - Get in Touch</title>
        <meta name="description" content="Contact Ziki Apparel customer service. Have questions? Get in touch with our team for support, inquiries, and feedback." />
        <meta name="keywords" content="contact us, customer service, support, inquiries" />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Contact Ziki Apparel - Get in Touch" />
        <meta property="og:description" content="Contact Ziki Apparel customer service for support and inquiries." />
      </Head>
      <Layout>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-gray-600">03060622399</p>
