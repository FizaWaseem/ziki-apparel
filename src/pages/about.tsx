...
export default function AboutPage() {
  return (
    <>
      <Head>
        <title>About Ziki Apparel - Our Story & Values</title>
        <meta name="description" content="Learn about Ziki Apparel. Discover our story, mission, values, and commitment to premium quality denim and sustainable fashion." />
        <meta name="keywords" content="about Ziki Apparel, brand story, sustainable fashion, premium denim, company values" />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="About Ziki Apparel - Our Story & Values" />
        <meta property="og:description" content="Learn about Ziki Apparel and our commitment to premium quality and sustainable fashion." />
      </Head>
      <Layout>
        <div className="min-h-screen bg-gray-50">
          ...
          <div className="bg-blue-50 py-16">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Why Ziki Apparel?</h2>
              <p className="text-xl text-gray-700 leading-relaxed">
                Our mission is to provide premium quality products at the most affordable prices for our clients.
              </p>
              <p className="text-lg text-gray-600 mt-4">
                We believe that quality fashion should be accessible to everyone. By optimizing our supply chain
                and cutting unnecessary costs, we pass savings directly to you without compromising on quality.
              </p>
            </div>
          </div>
